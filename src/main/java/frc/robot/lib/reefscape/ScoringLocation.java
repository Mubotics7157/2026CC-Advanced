package frc.robot.lib.reefscape;
...
public class ScoringLocation {
    ...
    public Pose2d getPoseWithoutReefBuffer() {
        double offset = FieldConstants.kAutoAlignReefUnbuffer;
    ...
    public static final ScoringLocation A = new ScoringLocation(FieldConstants.kBranchPoses[1], 0);
    public static final ScoringLocation B = new ScoringLocation(FieldConstants.kBranchPoses[0], 1);
    public static final ScoringLocation C = new ScoringLocation(FieldConstants.kBranchPoses[11], 2);
    public static final ScoringLocation D = new ScoringLocation(FieldConstants.kBranchPoses[10], 3);
    public static final ScoringLocation E = new ScoringLocation(FieldConstants.kBranchPoses[9], 4);
    public static final ScoringLocation F = new ScoringLocation(FieldConstants.kBranchPoses[8], 5);
    public static final ScoringLocation G = new ScoringLocation(FieldConstants.kBranchPoses[7], 6);
    public static final ScoringLocation H = new ScoringLocation(FieldConstants.kBranchPoses[6], 7);
    public static final ScoringLocation I = new ScoringLocation(FieldConstants.kBranchPoses[5], 8);
    public static final ScoringLocation J = new ScoringLocation(FieldConstants.kBranchPoses[4], 9);
    public static final ScoringLocation K = new ScoringLocation(FieldConstants.kBranchPoses[3], 10);
    public static final ScoringLocation L = new ScoringLocation(FieldConstants.kBranchPoses[2], 11);

    public static final ScoringLocation AB = new ScoringLocation(FieldConstants.kAlgaePoses[0], -1);
    public static final ScoringLocation CD = new ScoringLocation(FieldConstants.kAlgaePoses[5], -1);
    public static final ScoringLocation EF = new ScoringLocation(FieldConstants.kAlgaePoses[4], -1);
    public static final ScoringLocation GH = new ScoringLocation(FieldConstants.kAlgaePoses[3], -1);
    public static final ScoringLocation IJ = new ScoringLocation(FieldConstants.kAlgaePoses[2], -1);
    public static final ScoringLocation KL = new ScoringLocation(FieldConstants.kAlgaePoses[1], -1);

    public static final ScoringLocation FeederRight =
            new ScoringLocation(FieldConstants.kFeederRightPose, -1);
    public static final ScoringLocation FeederLeft =
            new ScoringLocation(FieldConstants.kFeederLeftPose, -1);

    public static final ScoringLocation Barge = new ScoringLocation(FieldConstants.kBargePose, -1);
