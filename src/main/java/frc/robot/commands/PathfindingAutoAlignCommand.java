...
import frc.robot.lib.reefscape.ScoringLocation;
...
public class PathfindingAutoAlignCommand extends Command {
    ...
    static final PathConstraints pathfindConstraints =
            new PathConstraints(
                    DriveConstants.kDriveMaxSpeed * kPathfindSpeedScalingFactor,
                    DriveConstants.kMaxAccelerationMetersPerSecondSquared
                            * kPathfindAccelScalingFactor,
                    DriveConstants.kDriveMaxAngularRate * kPathfindAngularScalingFactor,
                    DriveConstants.kMaxAngularSpeedRadiansPerSecondSquared
                            * kPathfindAngularScalingFactor,
                    DriveConstants.kMaxXAccelerationMetersPerSecondSquared
                            * kPathfindAccelScalingFactor,
                    DriveConstants.kMaxYAccelerationMetersPerSecondSquared
    ...
    static final PathConstraints slowPathfindConstraints =
            new PathConstraints(
                    DriveConstants.kDriveMaxSpeed * kSlowPathfindSpeedScalingFactor,
                    DriveConstants.kMaxAccelerationMetersPerSecondSquared
                            * kSlowPathfindAccelScalingFactor,
                    DriveConstants.kDriveMaxAngularRate * kSlowPathfindAngularScalingFactor,
                    DriveConstants.kMaxAngularSpeedRadiansPerSecondSquared
    ...
    static final PathConstraints pathfindToFeederConstraints =
            new PathConstraints(
                    DriveConstants.kDriveMaxSpeed * kPathfindToFeederSpeedScalingFactor,
                    DriveConstants.kMaxAccelerationMetersPerSecondSquared
                            * kPathfindToFeederAccelScalingFactor,
                    DriveConstants.kDriveMaxAngularRate * kPathfindToFeederSpeedScalingFactor,
                    DriveConstants.kMaxAngularSpeedRadiansPerSecondSquared
                            * kPathfindToFeederAccelScalingFactor,
                    DriveConstants.kMaxXAccelerationMetersPerSecondSquared
                            * kPathfindToFeederAccelScalingFactor,
    ...
    static final PathConstraints joinPathConstraints =
            new PathConstraints(
                    Math.min(
                            ...
                            DriveConstants.kDriveMaxSpeed * kJoinPathSpeedScalingFactor),
                    DriveConstants.kMaxAccelerationMetersPerSecondSquared
                            * kJoinPathAccelSpeedScalingFactor,
                    DriveConstants.kDriveMaxAngularRate * kJoinPathAngularScalingFactor,
                    DriveConstants.kMaxAngularSpeedRadiansPerSecondSquared
    ...
    static final PathConstraints slowJoinPathConstraints =
            new PathConstraints(
                    Math.min(
                            Constants.AutoConstants.kMaxEndPathVelocity,
                            DriveConstants.kDriveMaxSpeed * kSlowJoinPathSpeedScalingFactor),
                    DriveConstants.kMaxAccelerationMetersPerSecondSquared
                            * kSlowJoinPathAccelScalingFactor,
                    DriveConstants.kDriveMaxAngularRate * kSlowJoinPathAngularScalingFactor,
                    DriveConstants.kMaxAngularSpeedRadiansPerSecondSquared
        ...
        Pose2d targetPose =
                auto
                        ...
                        ? targetLocation.getPosePlusTransform(
                                FieldConstants.kAutoAlignReefBuffer
                                        - FieldConstants.kAutoAlignReefBufferAuto)
        ...
        if (shortJoinPath) {
            Transform2d shorterBuffer =
                    new Transform2d(
                            new Translation2d(
                                    isAlgae
                                            ? FieldConstants.kAutoAlignReefBackoffDistance
                                            : FieldConstants.kAutoAlignReefBackoffDistance,
                                    0.0),
                            Rotation2d.kZero);
                            ...
                            new Transform2d(
                                    new Translation2d(
                                            (DriverStation.isAutonomous()
                                                    ...
                                                    ? FieldConstants.kAutoAlignFeederBufferAuto
                                                    : FieldConstants.kAutoAlignFeederBufferTeleop,
                                            0.0),
                                    Rotation2d.kZero));
        } else if (reefBackoff) {
            endPose =
                    endPose.plus(
                            new Transform2d(
                                    new Translation2d(
                                            isAlgae
                                                    ? FieldConstants
                                                            .kAutoAlignAlgaeReefBackoffDistance
                                                    : FieldConstants.kAutoAlignReefBackoffDistance,
                                            0.0),
                                    Rotation2d.kZero));
                        ...
                        startPose.plus(
                                new Transform2d(
                                        new Translation2d(
                                                branch == ReefBranch.FEEDER_GROUND
                                                        ? FieldConstants
                                                                .kAutoAlignFeederGroundBufferAuto
                                                        : 0.15,
                                                0.0),
                                        Rotation2d.kZero));
            }
